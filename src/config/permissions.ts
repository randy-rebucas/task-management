...
export const ROLE_DEFINITIONS = {
  ...
  "operations-manager": {
    ...
    permissions: [
      ...
      "users:create", "users:view", "users:update", "users:delete", "users:import",
      "roles:view",
      ...
      "dashboard:admin", "dashboard:manager", "dashboard:staff",
  ...
  "field-coordinator": {
    ...
    permissions: [
      "tasks:create", "tasks:view", "tasks:view_all", "tasks:update", "tasks:assign", "tasks:approve",
      "users:view",
      "departments:view",
      "reports:view",
      "activity_logs:view",
